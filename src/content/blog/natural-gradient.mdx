...
where $\rho = [1/a_1,\cdots, 1/a_p]^\top$. A trivial application of this would be a setting in which each of the elements of $x$ has a different scale (e.g., perhaps some are in miles and others are in kilometers). Using a diagonal $A$ would account for this different scales.
...
<center>
<figure>
  <img src="/images/natural-gradient/gd_euclidean_mahalanobis.png" />
...
<center>
<figure>
  <img src="/images/natural-gradient/univariate_gaussian_euclidean.png" alt="Univariate Gaussian comparison" />
